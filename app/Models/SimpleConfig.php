...
class SimpleConfig extends Model{
    ...
    //修改数据
    public static function editSimpleConfig($where,$param){
    ...
    //添加数据
    public static function addSimpleConfig($param){
        $model = new SimpleConfig();
        $model->simple_id = $param['simple_id'];//组织ID
