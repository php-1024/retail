<?php
/**
 * simple_check_order表的模型
 *
 */
namespace App\Models;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\SoftDeletes;
class SimpleCheckOrder extends Model{
    use SoftDeletes;
    protected $table = 'simple_check_order';
    ...
    public function SimpleCheckOrderGoods(){
        return $this->hasMany('App\Models\SimpleCheckOrderGoods','order_id','id');
    }
    ...
    {
        $model = self::with('SimpleCheckOrderGoods');
    ...
    public static function getPaginage($where,$search_data,$paginate,$orderby,$sort='DESC'){
        ...
        return $model->with('SimpleCheckOrderGoods')->where($where)->orderBy($orderby,$sort)->paginate($paginate);
    }
}
?>