...
class Organization extends Model{
    ...
    public static function getPaginage($where,$paginate,$orderby,$sort='DESC'){
        return self::with('organizationproxyinfo')->join('warzone_proxy','warzone_proxy.organization_id','=','organization.id')->where($where)->orderBy($orderby,$sort)->paginate($paginate);
    }
    //获取分页数据-商户
