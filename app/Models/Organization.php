...
class Organization extends Model
{
    ...
    {
        return self::where($where)->join('organization_simpleinfo as s', 'organization.id', '=', 's.organization_id')->select('organization.id', 'organization.organization_name','s.description', 's.simple_logo', 's.address', 's.lat', 's.lng')->get();
    }
