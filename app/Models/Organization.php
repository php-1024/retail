...
class Organization extends Model{
    ...
    public static function getPaginage($where,$paginate,$orderby,$sort='DESC'){
        return self::with('warzoneProxy','organizationproxyinfo')->join('warzone','warzone.id','=','organization.warzoneProxy.zone_id')->where($where)->orderBy($orderby,$sort)->paginate($paginate);
    }
    //获取分页数据-商户
