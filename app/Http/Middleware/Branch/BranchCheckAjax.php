...
class BranchCheckAjax{
    public function handle($request, Closure $next)
    {
        ...
        switch ($route_name) {
            ...
            case "branch/ajax/edit_spec":               //编辑规格弹窗页面
            case "branch/ajax/delete_spec":             //删除规格弹窗页面
            case "branch/ajax/edit_spec_item":          //编辑子规格弹窗页面
            case "branch/ajax/delete_spec_stem":        //删除子规格弹窗页面
