...
//                如果不为空跳转到首页
            ...
            /****公众号管理****/
            //case "fansmanage/subscription/setting":                   //公众号授权
            ...
            /****公众号管理-消息管理****/
            case "fansmanage/news/message":                   //关键词自动回复
            case "fansmanage/news/message_attention":         //关注后自动回复
            case "fansmanage/news/message_default":           //默认回复
            case "fansmanage/news/message_mass":              //消息群发
            /****公众号管理-消息管理****/
            ...
            /****下属管理--权限角色****/
            case "fansmanage/role/role_add":                  //权限角色添加
            case "fansmanage/role/role_list":                 //权限角色列表
            /****下属管理--权限角色****/

            /****下级人员管理--添加组****/
            case "fansmanage/subordinate/subordinate_add":    //下级人员添加
            case "fansmanage/subordinate/subordinate_list":   //下级人员列表
            case "fansmanage/subordinate/quick_rule":         //添加下级人员快速授权
            /****下级人员管理--添加组****/

            /****财务管理****/
            case "fansmanage/finance/balance":                //余额管理
            case "fansmanage/finance/balance_recharge":       //余额详情
            case "fansmanage/finance/credit":                 //积分管理
            case "fansmanage/finance/credit_recharge":        //充值扣费
            case "fansmanage/finance/commission":             //佣金管理
            /****财务管理****/

            /****支付设置****/
            case "fansmanage/payment/wechat_setting":         //微信支付
            case "fansmanage/payment/zerone_setting":         //零舍壹得
            case "fansmanage/payment/sheng_setting":          //盛付通
            case "fansmanage/payment/kuai_setting":           //快付通
            /****支付设置****/

            /****支付设置****/
            case "fansmanage/goods/goods_category":           //商品分类查询
            case "fansmanage/goods/goods_list":               //商品查询
            case "fansmanage/goods/goods_detail":             //商品查看详情
            /****支付设置****/

            /****总分店管理****/
            case "fansmanage/store/branch_create":            //创建总分店
            case "fansmanage/store/branch_list":              //总分店管理
            /****总分店管理****/

            /****总分店管理****/
            case "fansmanage/card/card_add":                  //添加会员卡
            case "fansmanage/card/card_list":                 //会员卡管理
            case "fansmanage/card/card_goods":                //调整适用商品
            /****总分店管理****/
