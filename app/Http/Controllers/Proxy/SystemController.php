...
class SystemController extends Controller{
    ...
    public function display(Request $request){
        ...
        if($admin_data['super_id'] == 1){
            ...
            $acc_num = Account::where($data)->count();
            return view('Proxy/System/index',['login_log_list'=>$login_log_list,'operation_log_list'=>$operation_log_list,'acc_num'=>$acc_num,'admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data]);
        }
    }
    //退出登录
