...
class SubordinateController extends Controller
{
    ...
    public function subordinate_add(Request $request)
    {
        ...
        return view('CateringBranch/Subordinate/subordinate_add',['selected_nodes'=>$selected_nodes,'selected_modules'=>$selected_modules,'module_node_list'=>$module_node_list,'role_list'=>$role_list,'admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data]);
    }
    ...
    public function quick_rule(Request $request){
        ...
        return view('CateringBranch/Subordinate/quick_rule',['module_node_list'=>$module_node_list,'selected_nodes'=>$selected_nodes,'selected_modules'=>$selected_modules]);
    }
    ...
    public function subordinate_list(Request $request){
        ...
        return view('CateringBranch/Subordinate/subordinate_list',['list'=>$list,'search_data'=>$search_data,'admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data]);
    }
    ...
    public function subordinate_edit(Request $request){
        ...
        return view('CateringBranch/Subordinate/subordinate_edit',['info'=>$info]);
    }
    ...
    public function subordinate_authorize(Request $request){
        ...
        $role_list = OrganizationRole::getList([['program_id',5],['created_by',$admin_data['id']]],0,'id');
        return view('CateringBranch/Subordinate/subordinate_authorize',['info'=>$info,'role_list'=>$role_list]);
    }
    ...
    public function selected_rule(Request $request){
        ...
        return view('CateringBranch/Subordinate/selected_rule',['module_node_list'=>$module_node_list,'selected_nodes'=>$selected_nodes,'selected_modules'=>$selected_modules]);
    }
    ...
    public function subordinate_lock(Request $request){
        ...
        return view('CateringBranch/Subordinate/subordinate_lock',['id'=>$id,'account'=>$account,'status'=>$status]);
    }
    //冻结解冻下级人员
