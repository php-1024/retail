...
class ProgramController extends Controller{
    ...
    public function menu_edit(Request $request){
        ...
        dump($second_list);
        return view('Tooling/Program/menu_edit',['parent_arr'=>$parent_arr,'list'=>$list,'second_lis'=>$second_list,'info'=>$info,'action_name'=>'program']);
    }
    //编辑菜单数据检测
    ...
    public function package_edit_check(Request $request){
        ...
        if(Package::checkRowExists([['id','<>',$id],[ 'package_name',$package_name ]])){
            ...
            try{
                ...
                //删除原本有这次没有的程序
                PackageProgram::where('package_id',$id)->whereNotIn('program_id',$program_ids)->forceDelete();
    ...
    public function package_remove(Request $request){
        ...
        try{
            ...
            PackageProgram::where('package_id',$id)->forceDelete();
