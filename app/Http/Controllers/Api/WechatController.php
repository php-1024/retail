...
class WechatController extends Controller{
    ...
    public function meterial_image_upload_check(Request $request){
        ...
        if ($file->isValid()) {
            ...
            $auth_info = \Wechat::refresh_authorization_info($admin_data['organization_id']);//刷新并获取授权令牌
            dump(base_path() . '/uploads/wechat/'.$admin_data['organization_id'].'/', $new_name);
            \Wechat::uploadimg($admin_data['organization_id'],base_path() . '/uploads/wechat/'.$admin_data['organization_id'].'/', $new_name);
