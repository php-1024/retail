...
class GoodsController extends Controller
{
    ...
    public function goods_add(Request $request)
    {
        ...
        return view('RetailBranch/Goods/goods_add', ['category' => $category, 'admin_data' => $admin_data, 'menu_data' => $menu_data, 'son_menu_data' => $son_menu_data, 'route_name' => $route_name]);
    }
    ...
    public function goods_edit(Request $request)
    {
        ...
        return view('RetailBranch/Goods/goods_edit', ['goods_thumb'=>$goods_thumb,'category' => $category, 'goods' => $goods, 'spec'=>$spec,'admin_data' => $admin_data, 'menu_data' => $menu_data, 'son_menu_data' => $son_menu_data, 'route_name' => $route_name]);
    }
    ...
    public function goods_thumb(Request $request)
    {
        ...
        $goods_thumb = CateringGoodsThumb::getList(['goods_id'=>$goods_id],0,'created_at','DESC');
        return view('RetailBranch/Goods/goods_thumb', ['goods_thumb'=>$goods_thumb]);
    }
    ...
    public function goods_spec(Request $request)
    {
        $goods_id = $request->get('goods_id');              //商品的ID
        $spec = CateringSpec::getList(['goods_id'=>$goods_id],0,'created_at','DESC');
        return view('RetailBranch/Goods/goods_spec', ['spec'=>$spec]);
    }
    ...
    public function spec_edit(Request $request)
    {
        ...
        return view('RetailBranch/Goods/goods_spec_edit', ['spec'=>$spec,'spec_id'=>$spec_id]);
    }
    //编辑规格类操作方法
    ...
    public function spec_delete(Request $request)
    {
        $spec_id = $request->get('spec_id');              //规格类ID
        $spec = CateringSpec::getOne(['id'=>$spec_id]);
        return view('RetailBranch/Goods/goods_spec_delete', ['spec'=>$spec]);
    }
    ...
    public function spec_item_edit(Request $request)
    {
        ...
        return view('RetailBranch/Goods/goods_spec_item_edit', ['spec_item'=>$spec_item]);
    }
    ...
    public function spec_item_delete(Request $request)
    {
        $spec_item_id = $request->get('spec_item_id');  //子规格ID
        $goods_id = $request->get('goods_id');          //商品ID
        return view('RetailBranch/Goods/goods_spec_item_delete', ['spec_item_id'=>$spec_item_id,'goods_id'=>$goods_id]);
    }
    ...
    public function spec_item_add(Request $request)
    {
        ...
        return view('RetailBranch/Goods/goods_spec_comfirm',['spec_id'=>$spec_id,'goods_id'=>$goods_id]);
    }
    ...
    public function goods_list(Request $request)
    {
        ...
        return view('RetailBranch/Goods/goods_list', ['goods' => $goods, 'admin_data' => $admin_data, 'menu_data' => $menu_data, 'son_menu_data' => $son_menu_data, 'route_name' => $route_name]);
    }
    ...
    public function goods_copy(Request $request)
    {
        ...
        $son_menu_data = $request->get('son_menu_data');    //中间件产生的管理员数据参数
        $route_name = $request->path();                         //获取当前的页面路由
        return view('RetailBranch/Goods/goods_copy', ['admin_data' => $admin_data, 'menu_data' => $menu_data, 'son_menu_data' => $son_menu_data, 'route_name' => $route_name]);
    }
}
