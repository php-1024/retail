...
class RoleController extends Controller
{
    ...
    public function role_add(Request $request)
    {
        ...
        return view('RetailBranch/Role/role_add',['module_node_list'=>$module_node_list,'admin_data'=>$admin_data,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data,'route_name'=>$route_name]);
    }
    ...
    public function role_list(Request $request)
    {
        ...
        return view('RetailBranch/Role/role_list',['list'=>$list,'role_module_nodes'=>$role_module_nodes,'search_data'=>$search_data,'admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data]);
    }
    ...
    public function role_edit(Request $request){
        ...
        return view('RetailBranch/Role/role_edit',['info'=>$info,'selected_modules'=>$selected_modules,'selected_nodes'=>$selected_nodes,'module_node_list'=>$module_node_list]);
    }
    //下级人员编辑检测
    ...
    public function role_delete(Request $request){
        $id = $request->input('id');
        return view('RetailBranch/Role/role_delete',['id'=>$id]);
    }
    //直接输入安全密码操作的页面检测
