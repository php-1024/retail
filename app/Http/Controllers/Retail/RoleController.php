...
class RoleController extends Controller
{
    ...
    public function role_add(Request $request)
    {
        ...
        return view('Retail/Role/role_add',['module_node_list'=>$module_node_list,'admin_data'=>$admin_data,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data,'route_name'=>$route_name]);
    }
