...
class StoreController extends Controller{
    ...
    public function branch_create(Request $request){
        ...
        return view('Retail/Store/branch_create',['onebranch'=>$onebranch,'onebranch'=>$onebranch,'package_program'=>$package_program,'admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data]);
        }
    ...
    public function branch_list(Request $request){
        ...
        return view('Retail/Store/branch_list',['listBranch'=>$listBranch,'admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data]);
    }
