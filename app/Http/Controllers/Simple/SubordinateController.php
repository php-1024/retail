...
class SubordinateController extends Controller
{
    ...
    public function subordinate_add(Request $request)
    {
        ...
        return view('Simple/Subordinate/subordinate_add', ['admin_data' => $admin_data, 'route_name' => $route_name, 'menu_data' => $menu_data, 'son_menu_data' => $son_menu_data]);
    }
    ...
    public function subordinate_list(Request $request)
    {
        ...
        return view('Simple/Subordinate/subordinate_list', ['list' => $list, 'search_data' => $search_data, 'admin_data' => $admin_data, 'route_name' => $route_name, 'menu_data' => $menu_data, 'son_menu_data' => $son_menu_data]);
    }
    ...
    public function subordinate_edit(Request $request)
    {
        ...
        return view('Simple/Subordinate/subordinate_edit', ['info' => $info]);
    }
    ...
    public function subordinate_lock(Request $request)
    {
        ...
        return view('Simple/Subordinate/subordinate_lock', ['id' => $id, 'account' => $account, 'status' => $status]);
    }
