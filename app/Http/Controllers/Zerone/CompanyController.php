...
class CompanyController extends Controller{
    ...
    public function company_add(Request $request){
        ...
        $list = Organization::orwhere(['type'=>'1','type'=>'2']);

        return view('Zerone/Company/company_add',['admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data,'warzone_list'=>$list]);
    }
    //提交服务商数据
