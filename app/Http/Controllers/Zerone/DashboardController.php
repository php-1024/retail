...
class DashboardController extends Controller{
    ...
    public function display(Request $request)
    {
        ...
        return view('Zerone/Dashboard/display',['admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data,'login_log_list'=>$login_log_list,'operation_log_list'=>$operation_log_list,'zerone_all'=>$zerone_all,'zerone'=>$zerone]);
    }
    //参数设置展示
