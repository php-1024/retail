...
class SubordinateController extends Controller{
    ...
    public function subordinate_add(Request $request){
        ...
        return view('Fansmanage/Subordinate/subordinate_add',['selected_nodes'=>$selected_nodes,'selected_modules'=>$selected_modules,'module_node_list'=>$module_node_list,'role_list'=>$role_list,'admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data]);
    }
    ...
    public function quick_rule(Request $request){
        ...
        return view('Fansmanage/Subordinate/quick_rule',['module_node_list'=>$module_node_list,'selected_nodes'=>$selected_nodes,'selected_modules'=>$selected_modules]);
    }
    ...
    public function subordinate_list(Request $request){
        ...
        return view('Fansmanage/Subordinate/subordinate_list',['list'=>$list,'search_data'=>$search_data,'admin_data'=>$admin_data,'route_name'=>$route_name,'menu_data'=>$menu_data,'son_menu_data'=>$son_menu_data]);
    }
    ...
    public function subordinate_edit(Request $request){
        ...
        return view('Fansmanage/Subordinate/subordinate_edit',['info'=>$info]);
    }
    ...
    public function subordinate_authorize(Request $request){
        ...
        $role_list = Role::getList([['program_id',4],['created_by',$admin_data['id']]],0,'id');
        return view('Fansmanage/Subordinate/subordinate_authorize',['info'=>$info,'role_list'=>$role_list]);
    }
    ...
    public function selected_rule(Request $request){
        ...
        return view('Fansmanage/Subordinate/selected_rule',['module_node_list'=>$module_node_list,'selected_nodes'=>$selected_nodes,'selected_modules'=>$selected_modules]);
    }
    ...
    public function subordinate_lock(Request $request){
        ...
        return view('Fansmanage/Subordinate/subordinate_lock',['id'=>$id,'account'=>$account,'status'=>$status]);
    }
    //冻结解冻下级人员
    ...
    public function subordinate_delete(Request $request){
        $id = $request->input('id');//要操作的用户的ID
        $account = $request->input('account');//要操作的管理员的账号,用于记录
        return view('Fansmanage/Subordinate/subordinate_delete',['id'=>$id,'account'=>$account]);
    }
