...
class WechatmenuController extends Controller{
    ...
    public function conditional_menu(Request $request){
        ...
        $re = \Wechat::get_fans_info($auth_info['authorizer_access_token'],'oyhbt1C__b9gvm_wg9bf5aFika48');
        dump($re);
    ...
    public function wechat_conditional_menu_add(Request $request){
        ...
        return view('Fansmanage/Wechatmenu/wechat_conditional_menu_add',['tag_id'=>$tag_id]);
    }
