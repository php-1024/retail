...
class WechatController extends Controller
{
    ...
    /**
     * 除全网发布外零壹的回复
     * @param string $jm 微信加密类
     * @param array $param 来源内容
     * @param string $appid 哪个公众号内传过来的消息
     * @param string $encrypt_type 是否密文传输
     * @param int $timestamp 发送时间戳
     * @param string $nonce 加密消息要用的数据
     * @return string
     */
