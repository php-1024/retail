        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <li @if ($action_name=='program')class="active"@endif>
                ...
                <ul class="nav nav-second-level collapse">
                    ...
                    <li @if ($route_name=='program/program/program_list')class="active"@endif><a href="{{ url('program/program/program_list') }}">程序列表</a></li>
                </ul>
            </li>
            ...
            <li  @if ($action_name=='node')class="active"@endif>
                ...
                <ul class="nav nav-second-level collapse">
                    <li @if ($route_name=='program/node/node_add')class="active"@endif><a href="{{ url('program/node/node_add') }}">添加节点</a></li>
