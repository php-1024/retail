...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/Retail')}}/js/nestable/nestable.css" type="text/css" />
                        ...
                        <section class="vbox animated fadeInUp">
                            <section class="scrollable hover">
                                <div class="list-group no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                                    <a href="{{url('Retail/menu/menu_customize')}}" class="list-group-item">
                                        自定义菜单
                                    </a>
                                    <a href="{{url('Retail/menu/menu_different')}}" class="list-group-item active">
                                        个性化菜单
                                    </a>
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="get">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">粉丝标签</label>
                                                    <div class="col-sm-10">
                                            ...
                                            <p class="text-danger">可根据粉丝标签 让 不同标签下的 用户看到 不同的个性化菜单。</p>
                                        </span>
                                                    </div>
                                                </div>
...
<script src="{{asset('public/Retail')}}/js/nestable/jquery.nestable.js"></script>
