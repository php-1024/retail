                    ...
                    <section class="scrollable padder">
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" id="currentForm" method="post" action="{{url('Retail/ajax/role_add_check')}}">
...
<script type="text/javascript" src="{{asset('public/Retail')}}/iCheck/js/icheck.min.js"></script>
