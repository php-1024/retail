<form class="form-horizontal tasi-form" method="post" role="form" id="currentForm" action="{{ url('retailbranch/ajax/subordinate_authorize_check') }}">
    ...
    <input type="hidden" id="selected_rule_url" value="{{ url('retailbranch/ajax/selected_rule') }}">
