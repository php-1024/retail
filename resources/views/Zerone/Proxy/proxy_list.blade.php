                                ...
                                <table class="table table-stripped toggle-arrow-tiny" data-page-size="15">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <button type="button" id="peoplesBtn" onclick="location.href='{{url('zerone/ajax/proxy_structure')}}'" class="btn btn-outline btn-xs btn-primary"><i class="fa fa-users"></i>&nbsp;&nbsp;人员架构</button>
