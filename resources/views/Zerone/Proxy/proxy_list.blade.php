                                    ...
                                    <tr>
                                        ...
                                        <form method="get" role="form" id="searchForm" action="{{url('zerone/proxy/proxy_structure')}}">
                                            ...
                                            <td class="text-right">
                                                ...
                                                <button type="button" id="companyBtn" onclick="location.href='{{url('zerone/proxy/proxy_campany')}}'" class="btn btn-outline btn-xs btn-danger"><i class="fa fa-arrow-circle-o-left"></i>&nbsp;&nbsp;商户划拨管理</button>
                                            </td>
                                        </form>
                                    </tr>
                                @endforeach
