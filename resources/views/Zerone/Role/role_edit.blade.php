                                ...
                                <div>
                                    @foreach($val->program_nodes as $kk=>$vv)
                                        <label class="checkbox-inline i-checks">
                                            <input type="checkbox" @if(in_array($val->id,$selected_nodes)) checked="checked" @endif  data-group_id="{{ $val->id }}" class="checkbox_node_name checkbox_node_name_{{ $val->id }}" name="module_node_ids[]" value="{{ $vv->id }}"> {{$vv->node_name}}
                                        </label>
                                    @endforeach
                                </div>
                            </group>
