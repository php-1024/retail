                        ...
                        <div class="ibox-content">
                            <table class="table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="label label-success" style="display:inline-block">@if(!empty($value['program_name'])){{$value['program_name']}}@else 还没有分配程序@endif：程序1套，分店{{$value['store']}}家</label><br />
                                    </td>
