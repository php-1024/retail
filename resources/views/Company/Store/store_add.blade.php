                        ...
                        <div class="col-sm-2">
                            <section class="panel panel-default"   style="height: 230px;">
                                <header class="panel-heading bg-light no-border">
                                    <div class="clearfix">
                                        ...
                                        <div class="clear">
                                            ...
                                            <i class="fa fa-rmb text-danger text-lg pull-left">{{$val['package_price']}}</i>
                                        </div>
                                    </div>
                                </header>
                                ...
                                <div class="panel-body" style="text-align:center;">
                                    <button class="btn btn-s-md btn-danger" onclick="location.href='{{url('company/store/store_add_second')}}?package_id={{$val['id']}}&package_name={{$val['package_name']}}'">立即开店</button>
                                </div>
                            </section>
                        </div>
                        @endforeach
