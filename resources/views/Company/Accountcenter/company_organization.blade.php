...
<section class="">
    ...
    <div class="row state-overview" style="margin: 10px;">
        <div class="form-group">
            <div class="col-lg-12">
                <div class="input-group m-bot15 col-lg-3 "> <span class="input-group-addon"><i class="icon-search"></i></span>
    ...
    <div class="row state-overview" style="margin: 10px;">
        <div class="col-lg-3 col-sm-6"> <a href="index.html">
                <section class="panel">
                    <div class="symbol terques"> <i class="icon-arrow-right"></i> </div>
                    <div class="value"> <b>零壹新科技（四平）有限公司</b>
                        <p>东北战区</p>
                    </div>
                </section>
            </a> </div>
        <div class="col-lg-3 col-sm-6"> <a href="index.html">
                <section class="panel">
                    <div class="symbol terques"> <i class="icon-arrow-right"></i> </div>
                    <div class="value"> <b>零壹新科技（吉林）有限公司</b>
                        <p>东北战区</p>
                    </div>
                </section>
            </a> </div>
        <div class="col-lg-3 col-sm-6"> <a href="index.html">
                <section class="panel">
                    <div class="symbol terques"> <i class="icon-arrow-right"></i> </div>
                    <div class="value"> <b>零壹新科技（沈阳）有限公司</b>
                        <p>东北战区</p>
                    </div>
                </section>
            </a> </div>
        <div class="col-lg-3 col-sm-6"> <a href="index.html">
                <section class="panel">
                    <div class="symbol terques"> <i class="icon-arrow-right"></i> </div>
                    <div class="value"> <b>零壹新科技（哈尔滨）有限公司</b>
                        <p>东北战区</p>
                    </div>
                </section>
            </a> </div>
