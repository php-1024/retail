                                    ...
                                    <li class="dd-item" data-id="1">
                                        <div class="dd-handle">
                                            ...
                                            <span class="pull-right">
                                                    <input type="tel" class="pull-left" value="{{ $val->sort }}" onclick="$(this).focus();"  style="width: 50px; text-align: center;">
                                                    &nbsp;&nbsp;
                                                <div class="btn-group">
                                                    ...
                                                    <ol class="dd-list">
                                                        @foreach($third_menu[$vv->id] as $kkk=>$vvv)
                                                            <li class="dd-item" data-id="2">
                                                                <div class="dd-handle">
                                                                    <span class="pull-right">
                                                                        <input type="text" value="{{ $vvv->sort }}" onclick="$(this).focus();" style="width: 50px; text-align: center;">
                                                                        &nbsp;&nbsp;
