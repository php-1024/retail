            ...
            <div class="modal-body">
                <form method="post" class="form-horizontal"  role="form" id="currentForm" action="{{ url('tooling/ajax/program_add_check') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="checkbox" name="is_asset" name="is_classic" @if($val->is_asset==1) checked @endif class="js-switch2"  value="1"/>
                        </div>
                    </div>
                    <div class="hr-line-dashed" style="clear:both;"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="checkbox" name="is_coupled" name="is_classic" @if($val->is_coupled==1) checked @endif class="js-switch3"  value="1"/>
                        </div>
                    </div>
                    <div class="hr-line-dashed" style="clear:both;"></div>
