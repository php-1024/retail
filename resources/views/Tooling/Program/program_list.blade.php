                            ...
                            <table class="table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label class="label label-primary" data-container="body" data-toggle="popover" data-placement="top" data-content="@foreach($val->modules->program_nodes as $kk=>$vv){{ $vv['node_name'] }} &nbsp;&nbsp;@endforeach" style="display:inline-block">{{ $v['module_name'] }}</label>&nbsp;&nbsp;
                                       @endforeach
                                    </td>
