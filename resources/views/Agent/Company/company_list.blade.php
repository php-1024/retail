                                ...
                                <section class="panel">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @foreach($list as $key=>$val)
                                            ...
                                            <td class="text-right">
                                                <button type="button" id="peoplesBtn" onclick="location.href='{{url('proxy/company/company_structure')}}?organization_id={{$val->id}}'" class="btn btn-outline btn-xs btn-primary"><i class="icon-sitemap"></i>&nbsp;&nbsp;店铺结构</button>
                                                <button type="button" id="programBtn" onclick="location.href='{{url('proxy/company/company_program')}}?organization_id={{$val->id}}'" class="btn btn-outline btn-xs btn-info"><i class="icon-code"></i>&nbsp;&nbsp;程序划拨</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
