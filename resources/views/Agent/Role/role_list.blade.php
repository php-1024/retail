                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <form class="form-horizontal tasi-form" method="get" id="searchForm" action="">
                                ...
                                <input type="hidden" id="role_edit_url" value="{{ url('Agent/ajax/role_edit') }}">
                                <input type="hidden" id="role_delete_comfirm_url" value="{{ url('Agent/ajax/role_delete') }}">
...
<script src="{{asset('public/Agent')}}/js/icheck.min.js"></script>
