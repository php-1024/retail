...
<form method="get" role="form" id="searchForm" action="">
    ...
    <input type="hidden" id="spec_edit" value="{{ url('retailbranch/ajax/spec_edit') }}">
    <input type="hidden" id="spec_delete" value="{{ url('retailbranch/ajax/spec_delete') }}">
    <input type="hidden" id="spec_item_edit" value="{{ url('retailbranch/ajax/spec_item_edit') }}">
    <input type="hidden" id="spec_item_delete" value="{{ url('retailbranch/ajax/spec_item_delete') }}">
    <input type="hidden" id="spec_item_add" value="{{ url('retailbranch/ajax/spec_item_add') }}">
    <div class="m-t">
