...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xl">
        ...
        <section class="m-b-lg">
            ...
            <form class="m-t" role="form" id="currentForm" action="{{ url('cateringbranch/ajax/login_check') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="captcha_url" value="{{ asset('cateringbranch/login/captcha') }}">
                    <img src="{{ asset('cateringbranch/login/captcha') }}/{{ time() }}" class="col-sm-6" id="login_captcha" onClick="return changeCaptcha();">
