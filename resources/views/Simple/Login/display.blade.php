    ...
    <div class="container aside-xl">
        ...
        <section class="m-b-lg">
            <header class="wrapper text-center">
                <strong>零壹云管理平台 - 简版店铺管理系统登录</strong>
            </header>
            <form class="m-t" role="form" id="currentForm" action="{{ url('simple/ajax/login_check') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="captcha_url" value="{{ asset('simple/login/captcha') }}">
                    <img src="{{ asset('simple/login/captcha') }}/{{ time() }}" class="col-sm-6" id="login_captcha" onClick="return changeCaptcha();">
...
<footer id="footer">
    <div class="text-center padder">
        <p>
            <small>零壹新科技深圳有限公司<br>&copy; 2014——2018</small>
        </p>
    </div>
</footer>
<!-- / footer -->
