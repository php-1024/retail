                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="row wrapper">
                                <form class="form-horizontal" method="get" id="searchForm" action="">
                                    ...
                                    <input type="hidden" id="supplier_edit_url" value="{{ url('simple/ajax/supplier_edit') }}">
                                    <input type="hidden" id="supplier_delete_comfirm_url" value="{{ url('simple/ajax/supplier_delete') }}">
