                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="row wrapper">
                                <form class="form-horizontal" method="get" id="searchForm" action="">
                                    ...
                                    <input type="hidden" id="category_edit_url" value="{{ url('simple/ajax/category_edit') }}">
                                    <input type="hidden" id="category_delete_comfirm_url" value="{{ url('simple/ajax/category_delete') }}">
                                    {{--<div class="col-sm-2">--}}
