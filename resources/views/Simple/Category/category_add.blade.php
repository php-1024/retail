...
<head>
    <meta charset="utf-8" />
    <title>添加商品分类 | 零壹云管理平台 | 零售版店铺管理系统</title>
                    ...
                    <section class="scrollable padder">
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form method="post" class="form-horizontal"  role="form" id="currentForm" action="{{ url('simple/ajax/category_add_check') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="category_sort" value="0">
                                        </div>
                                    </div>
                                    <div class="line line-dashed b-b line-lg pull-in"></div>
                                    <div class="form-group">
