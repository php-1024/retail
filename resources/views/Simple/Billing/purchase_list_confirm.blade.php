<form class="form-horizontal tasi-form" method="post" id="currentForm" action="{{ url('simple/ajax/purchase_list_confirm_check') }}">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{$order->SimpleSupplier->company_name}}" class="form-control" disabled="" name="company_name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 text-right">供应商联系方式</label>
                        <div class="col-sm-10">
                            <input type="text" value="{{$order->SimpleSupplier->contactmobile}}" class="form-control" disabled="" name="contactmobile">
                        </div>
                    </div>
                    <div class="form-group">
