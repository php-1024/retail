                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="row wrapper">
                                <form class="form-horizontal" method="get">
                                    ...
                                    <input type="hidden" id="purchase_list_confirm" value="{{ url('simple/ajax/purchase_list_confirm') }}">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                    ...
                                    <tr>
                                        ...
                                        <td><label class="label label-success">{{$val->SimpleSupplier->company_name}}</label></td>
                                        <td>
                                                {{$val->SimpleSupplier->contactmobile}}
                                        </td>
                                        <td>
