                ...
                <section class="vbox">
                    <section class="scrollable padder">
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="line line-border b-b pull-in"></div>
                            <form method="post" class="form-horizontal"  role="form" id="purchase_goods" action="{{ url('simple/ajax/check_goods_check') }}">
                                <div class="tab-pane">
                                    <div class="col-lg-7">
                                        <section class="panel panel-default">
        ...
        $.post(url, data, function (json) {
            if (json.status == -1) {
                ...
                swal({
                    ...
                    window.location.href = "{{url('simple/billing/check_goods')}}";
                });
            }else{
                swal({
                    title: "提示信息",
