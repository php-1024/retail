                ...
                <section class="vbox">
                    <section class="scrollable padder">
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="line line-border b-b pull-in"></div>
                            <div class="col-sm-12">
                                <form method="post" class="form-horizontal"  role="form" id="search_company" action="{{ url('simple/ajax/search_company') }}">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                ...
                                <footer class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-12 col-sm-offset-6">
                                            <button type="button" class="btn btn-success" onclick="PostForm('2')">确认提交</button>
                                        </div>
                                    </div>
                                </footer>
                            </form>
        ...
        $.post(url, data, function (json) {
            if (json.status == -1) {
                ...
                swal({
                    ...
                    window.location.href = "{{url('simple/billing/purchase_goods')}}";
                });
            }else{
                swal({
                    title: "提示信息",
