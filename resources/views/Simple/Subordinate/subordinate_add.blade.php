...
<head>
    ...
    <link href="{{asset('public/Simple/library')}}/iCheck/css/custom.css" rel="stylesheet">
    <!--[if lt IE 9]>
                    ...
                    <section class="scrollable padder">
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form  method="post" class="form-horizontal" id="currentForm" action="{{ url('simple/ajax/subordinate_add_check') }}">
...
<script src="{{asset('public/Simple/library')}}/wizard/js/jquery.bootstrap.wizard.min.js"></script>
<script src="{{asset('public/Simple/library')}}/iCheck/js/icheck.min.js"></script>
