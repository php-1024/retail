                            ...
                            <section class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <input type="hidden" id="order_status_comfirm_url" value="{{ url('simple/ajax/order_status') }}">
                                        <input type="hidden" id="order_status_paytype" value="{{ url('simple/ajax/order_status_paytype') }}">
