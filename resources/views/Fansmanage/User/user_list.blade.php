                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="row wrapper">
                                <form class="form-horizontal" method="get">
                                    <input type="hidden" id="store_label_add_check" value="{{ url('fansmanage/ajax/store_label_add_check') }}">
                                    <input type="hidden" id="user_list_edit" value="{{ url('fansmanage/ajax/user_list_edit') }}">
                                    <input type="hidden" id="user_list_wallet" value="{{ url('fansmanage/ajax/user_list_wallet') }}">
                                    <input type="hidden" id="user_list_lock" value="{{ url('fansmanage/ajax/user_list_lock') }}">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select style="width:100px" class="chosen-select2" onchange="changeUserTag(this,'{{$value->user_id}}','{{$value->nickname}}')">
