                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="row wrapper">
                                <form class="form-horizontal" method="get" id="searchForm" action="">
                                    ...
                                    <input type="hidden" id="role_edit_url" value="{{ url('fansmanage/ajax/role_edit') }}">
                                    <input type="hidden" id="role_delete_comfirm_url" value="{{ url('fansmanage/ajax/role_delete') }}">
