<form class="form-horizontal tasi-form" method="post" role="form" id="currentForm" action="{{ url('fansmanage/ajax/subordinate_authorize_check') }}">
    ...
    <input type="hidden" id="selected_rule_url" value="{{ url('fansmanage/ajax/selected_rule') }}">
