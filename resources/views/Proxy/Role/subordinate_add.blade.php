                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2"><button type="button" class="btn btn-primary"><i class="icon-arrow-down"></i>&nbsp;&nbsp;快速授权</button></div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <ul class="pager wizard">
                                            ...
                                            <li class="finish"><button type="button" id="addbtn" class="btn btn-primary">完成&nbsp;&nbsp;<i class="icon-arrow-right"></i></button></li>
                                        </ul>
                                    </div>
                                </div>
                            </form>
