...
Route::group(['prefix'=>'program'],function(){ 
    Route::get('/', 'Program\SystemController@dashboard')->middleware('ProgramCheck');//系统首页
    ...
    Route::group(['prefix'=>'ajax'],function(){
        ...
        Route::post('program_add_check','Program\ProgramController@program_add_check')->middleware('ProgramCheckIsLoginAjax','ProgramProgramAddCheck');//提交功能模块数据
        Route::post('program_parents_node','Program\ProgramController@program_parents_node')->middleware('ProgramCheckIsLoginAjax');//获取上级程序ID
        Route::post('program_edit','Program\ProgramController@program_edit')->middleware('ProgramCheckIsLoginAjax');//获取功能模块数据并提交
        Route::post('program_edit_check','Program\ProgramController@program_edit_check')->middleware('ProgramCheckIsLoginAjax','ProgramProgramEditCheck');//获取功能模块数据并提交
    });
});
/********************程序管理系统*************************/
