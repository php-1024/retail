...
Route::group(['prefix'=>'catering'],function(){
    ...
    Route::group(['prefix'=>'ajax'],function(){
        ...
        Route::post('label_edit','Catering\UserController@label_edit')->middleware('FansmanageCheck');                //编辑会员标签功能提交
        ...
        Route::post('label_wechat_check','Catering\UserController@label_wechat_check')->middleware('CateringCheck');//微信同步会员标签功能提交
