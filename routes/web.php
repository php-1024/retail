...
Route::group(['prefix'=>'proxy'],function(){
    ...
    Route::group(['prefix'=>'system'],function(){
        Route::post('select_proxy','Proxy\SystemController@select_proxy');//超级管理员选择登入的服务商
...
Route::group(['prefix'=>'company'],function(){
    ...
    Route::get('company_switch', 'Company\AccountcenterController@company_switch')->middleware('CompanyCheck');//退出重新选择商户
    //登录页面组
    Route::group(['prefix'=>'login'],function(){
