...
Route::group(['prefix'=>'proxy'],function(){
    ...
    Route::get('switch_status', 'Proxy\SystemController@display')->middleware('ProxyCheck');//超级管理员切换服务商
    ...
    Route::group(['prefix'=>'system'],function(){
        ...
        Route::get('proxy_operationlog','Proxy\SystemController@proxy_operationlog')->middleware('ProxyCheck');//操作日志
        Route::get('proxy_loginlog','Proxy\SystemController@proxy_loginlog')->middleware('ProxyCheck');//登录日志
    });
    //个人信息分组
