...
Route::group(['prefix'=>'catering'],function(){
    ...
    Route::group(['prefix'=>'subscription'],function(){
        Route::get('subscription_setting', 'Subscription\SubscriptionController@subscription_setting')->middleware('CateringCheck');      //公众号设置
        Route::get('subscription_material', 'Subscription\SubscriptionController@subscription_material')->middleware('CateringCheck');    //图文素材
        Route::get('subscription_message', 'Subscription\SubscriptionController@subscription_message')->middleware('CateringCheck');      //消息管理
        Route::get('subscription_menu', 'Subscription\SubscriptionController@message_sesubscription_menutting')->middleware('CateringCheck'); //菜单管理
    });
    //下属管理--权限角色组
    Route::group(['prefix'=>'role'],function(){
