...
Route::group(['prefix'=>'catering'],function(){
    ...
    Route::group(['prefix'=>'ajax'],function(){
        ...
        Route::post('label_wechat','Catering\UserController@label_wechat')->middleware('CateringCheckAjax');            //微信同步会员标签
        Route::post('label_wechat_check','Catering\UserController@label_wechat_check')->middleware('CateringCheckAjax');//微信同步会员标签功能提交
...
Route::group(['prefix'=>'fansmanage'],function(){
    ...
    Route::group(['prefix'=>'ajax'],function(){
        ...
        Route::any('defined_menu_add','Fansmanage\WechatmenuController@defined_menu_add');//添加自定义菜单板块
