...
Route::group(['prefix'=>'program'],function(){
    ...
    Route::group(['prefix'=>'ajax'],function(){
        ...
        Route::post('check_account_add','Program\SystemController@account_add_check')->middleware('ProgramCheckIsLoginAjax','ProgramCheckIsSuperAjax','AccountAddCheck');//提交增加账号数据
    });
});
/********************程序管理系统*************************/
